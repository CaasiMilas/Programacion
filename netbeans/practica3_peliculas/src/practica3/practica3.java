...
public class practica3 extends javax.swing.JFrame {
  ...
  private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
	String nameMovie = this.jTextField1.getText();
	boolean alreadyExist = false;
	
	if(nameMovie.isBlank() || nameMovie.isEmpty()){
		return;
	}
	for(int i = 0; i < jComboBox1.getItemCount(); i++){
		String nameItem = jComboBox1.getItemAt(i);
		if(nameMovie.equalsIgnoreCase(nameItem)){
			alreadyExist = true;
			break;
		}
	}
	if (alreadyExist) {
		JOptionPane.showMessageDialog(this, "El elemento ya existe");
	} else {
		jComboBox1.addItem(nameMovie);
	}
