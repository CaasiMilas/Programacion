 ...
 * @author salim
 */
public class practica5_imitador extends javax.swing.JFrame {

    /**
     * Creates new form practica5_imitador
     */
    public practica5_imitador() {
        initComponents();
  ...
  private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(practica5_imitador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new practica5_imitador().setVisible(true);
            }
        });
    }
